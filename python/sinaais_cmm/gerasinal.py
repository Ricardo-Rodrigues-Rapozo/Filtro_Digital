...
caminho_saida = r"C:\Users\Ricardo\Documents\Dissertação\procTest_00\Simulation\input_0.txt"   # ajuste o caminho
filtropython = r"C:\Users\Ricardo\Documents\Dissertação\python\y_python.txt"   # ajuste o caminho
arquivo = salvar_uma_coluna(caminho_saida, Q*x[:Nc*Nppc], fmt="%d")
filtropython_arquivo = salvar_uma_coluna(filtropython, y, fmt="%f")
print(f"OK! Arquivo salvo em: {arquivo}")
print(f"OK! Arquivo salvo em: {filtropython_arquivo}")